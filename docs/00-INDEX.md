...
| **发布包备份恢复** | [`05-DEVELOPMENT/RELEASE_PACKAGE_BACKUP_RESTORE.md`](./05-DEVELOPMENT/RELEASE_PACKAGE_BACKUP_RESTORE.md) | 发布产物备份与恢复流程 |
| **双端 UI 契约** | [`08-UI-SPECS/PARITY_MASTER_PLAN.md`](./08-UI-SPECS/PARITY_MASTER_PLAN.md) | 双端一致性总纲（五层防线）+ `screens/*.yaml` 逐屏规格 |
...
| [`OVERSEAS_SERVER_DEPLOYMENT.md`](./03-TECHNICAL-SPECS/OVERSEAS_SERVER_DEPLOYMENT.md) | 海外服务器部署（Ktor 网关运维） |
