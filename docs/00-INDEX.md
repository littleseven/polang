...
| **本地环境** | `05-DEVELOPMENT/LOCAL_ENVIRONMENT.md`（内部，不上线） | 本机开发路径与工具上下文 |
...
- **执行 QA / 看性能指标** → [NFR_SPEC](./01-PRODUCT/NFR_SPEC.md) → [BEAUTY_ENGINE_TECH_SPEC](./03-TECHNICAL-SPECS/BEAUTY_ENGINE_TECH_SPEC.md)
