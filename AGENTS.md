...
| **工程师任务卡（Spec，P1 已落地 + 任务中心已落地）** | `docs/superpowers/specs/2026-09-25-engineer-task-card-design.md`（工程师模式任务卡 + 任务中心页，Muse 任务卡范式；原生 Compose，不经 ADR-014 管线；P1 在场态与 US-12~16 任务中心已落地（2026-09-26），US-4~6 回联待 P2 网关改造） |
| **产品定义** | `PRODUCT.md` |
