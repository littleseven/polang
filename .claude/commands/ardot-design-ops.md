...
| Guide 图文重映射 SSOT(2026-09-26) | setup-* 与文案错位(编辑人物页顶模型中心)且未随微信化重烘 | 源帧钉语言→3x 导出→灌 guide 卡 Screen 子节点→导卡,终态回 zh;映射=entry 设置总览/1 本地模型/2 tag_control 顶裁 **0–852(1x)=0–2556(@3x) 首屏完整段,含图库统计+扫描状态段(「扫描中」pill 必须入镜)**/3 底裁 y443–1295(=1329–3885@3x,分阶段+重新生成+GPU)/4 账号/preview 聊天;**05/06 虽网站未引用也须同步补结构**——画布一致性优先;顶裁勿按半屏猜,先读整页分段定界(2026-09-26 二修:0–443 裁法漏扫描段被 QA 打回) |
| 营销帧边框范式定案(2026-09-26;2026-09-27 商店边框减半) | 深色截图的边框选型;Light 钉帧内 onSurface 渲成深灰 | 统一纯白:边框一律绑 color/white($143:3,双模恒 #FFFFFF);guide 卡结构=边框帧(padding12/外角28)+Screen 子(内角18);海报=pad12/外角52/内角40(700×1498,原24/60 减半)、FG=pad4/外角28/内角24(210×450,原7/30)——外角=内角+边厚保持同心;勿用 $2:149(Light 钉下变 #181818) |
...
| 1.9.1 | 2026-09-26 | 官网 guide 图二修实战回填:tag_control 顶裁边界定死 0–852 首屏(陷阱表 Guide SSOT 行修订)+en/tw 首页裸 setup 引用补 ?v 缓存戳 |
| 1.9.2 | 2026-09-27 | 商店图手机边框减半实战回填:海报 pad24→12/外角60→52、FG pad7→4/外角30→28(外角=内角+边厚保持同心;陷阱表范式行修订);27 帧逐帧单导+像素边宽判据(12px/4px)+MD5 防混 + refs 全量落盘 |
